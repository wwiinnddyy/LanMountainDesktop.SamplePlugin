...
- 当前版本：`0.0.7`
- 当前 Release 标签：`v0.0.7`
- 当前根目录发布包：`LanMountainDesktop.SamplePlugin.0.0.7.laapp`
...
- Current release tag: `v0.0.7`
- Current root package: `LanMountainDesktop.SamplePlugin.0.0.7.laapp`
